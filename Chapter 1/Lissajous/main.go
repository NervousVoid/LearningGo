...
var palette = []color.Color{color.Black, color.RGBA{G: 0xff, A: 0xff}, color.RGBA{R: 0xff, A: 0xff}, color.RGBA{B: 0xff, A: 0xff}}
...
func lissajous(out io.Writer) {
	...
	for i := 0; i < nframes; i++ {
		...
		for t := 0.0; t < cycles*2*math.Pi; t += res {
			...
			// Генерируются не изображения разных цветов, а каждый пиксель. Если хотим пиксели одинкавого цвета
			// в пределах одного кадра, просто выносим рандом из цикла
